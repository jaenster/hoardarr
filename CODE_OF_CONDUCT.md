...
hoardarr a harassment-free experience for everyone, regardless of age,
...
be reported via [GitHub private security
advisories](https://github.com/jaenster/hoardarr/security/advisories/new)
(the same private channel used for security reports — it is the only
channel maintainers monitor privately). All complaints will be reviewed
